...
function alu() {
  ...
  function calculate() {
    ...
    neg_x[0] = OR(AND(zero_x[0], NOT(elem_neg_x.checked)), AND(elem_neg_x.checked, zero_x[0]));
    neg_x[1] = OR(AND(zero_x[1], NOT(elem_neg_x.checked)), AND(elem_neg_x.checked, XOR(zero_x[1], zero_x[0])));
    neg_x[2] = OR(AND(zero_x[2], NOT(elem_neg_x.checked)), AND(elem_neg_x.checked, XOR(zero_x[2], OR(zero_x[1], zero_x[0]))));
    neg_x[3] = OR(AND(zero_x[3], NOT(elem_neg_x.checked)), AND(elem_neg_x.checked, XOR(zero_x[3], OR(zero_x[2], OR(zero_x[1], zero_x[0])))));
    neg_x[4] = OR(AND(zero_x[4], NOT(elem_neg_x.checked)), AND(elem_neg_x.checked, XOR(zero_x[4], OR(zero_x[3], OR(zero_x[2], OR(zero_x[1], zero_x[0]))))));
    neg_x[5] = OR(AND(zero_x[5], NOT(elem_neg_x.checked)), AND(elem_neg_x.checked, XOR(zero_x[5], OR(zero_x[4], OR(zero_x[3], OR(zero_x[2], OR(zero_x[1], zero_x[0])))))));
    neg_x[6] = OR(AND(zero_x[6], NOT(elem_neg_x.checked)), AND(elem_neg_x.checked, XOR(zero_x[6], OR(zero_x[5], OR(zero_x[4], OR(zero_x[3], OR(zero_x[2], OR(zero_x[1], zero_x[0]))))))));
    neg_x[7] = OR(AND(zero_x[7], NOT(elem_neg_x.checked)), AND(elem_neg_x.checked, XOR(zero_x[7], OR(zero_x[6], OR(zero_x[5], OR(zero_x[4], OR(zero_x[3], OR(zero_x[2], OR(zero_x[1], zero_x[0])))))))));
    ...
    neg_y[0] = OR(AND(zero_y[0], NOT(elem_neg_y.checked)), AND(elem_neg_y.checked, zero_y[0]));
    neg_y[1] = OR(AND(zero_y[1], NOT(elem_neg_y.checked)), AND(elem_neg_y.checked, XOR(zero_y[1], zero_y[0])));
    neg_y[2] = OR(AND(zero_y[2], NOT(elem_neg_y.checked)), AND(elem_neg_y.checked, XOR(zero_y[2], OR(zero_y[1], zero_y[0]))));
    neg_y[3] = OR(AND(zero_y[3], NOT(elem_neg_y.checked)), AND(elem_neg_y.checked, XOR(zero_y[3], OR(zero_y[2], OR(zero_y[1], zero_y[0])))));
    neg_y[4] = OR(AND(zero_y[4], NOT(elem_neg_y.checked)), AND(elem_neg_y.checked, XOR(zero_y[4], OR(zero_y[3], OR(zero_y[2], OR(zero_y[1], zero_y[0]))))));
    neg_y[5] = OR(AND(zero_y[5], NOT(elem_neg_y.checked)), AND(elem_neg_y.checked, XOR(zero_y[5], OR(zero_y[4], OR(zero_y[3], OR(zero_y[2], OR(zero_y[1], zero_y[0])))))));
    neg_y[6] = OR(AND(zero_y[6], NOT(elem_neg_y.checked)), AND(elem_neg_y.checked, XOR(zero_y[6], OR(zero_y[5], OR(zero_y[4], OR(zero_y[3], OR(zero_y[2], OR(zero_y[1], zero_y[0]))))))));
    neg_y[7] = OR(AND(zero_y[7], NOT(elem_neg_y.checked)), AND(elem_neg_y.checked, XOR(zero_y[7], OR(zero_y[6], OR(zero_y[5], OR(zero_y[4], OR(zero_y[3], OR(zero_y[2], OR(zero_y[1], zero_y[0])))))))));
...
;
render(state);
},{"./components/template.js":"components/template.js","./components/navigation.js":"components/navigation.js","./content/home.js":"content/home.js","./content/bio.js":"content/bio.js","./content/projects.js":"content/projects.js","./content/blog.js":"content/blog.js","./content/blog/abstraction.js":"content/blog/abstraction.js","./content/blog/elementary.js":"content/blog/elementary.js","./content/blog/boolean.js":"content/blog/boolean.js","./content/blog/representing.js":"content/blog/representing.js","./content/blog/decisions.js":"content/blog/decisions.js","./content/contact.js":"content/contact.js","./content/blog/alu.js":"content/blog/alu.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
